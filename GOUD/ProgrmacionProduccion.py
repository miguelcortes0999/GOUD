...
class BalanceoLienaProgramacionLineal():
    def __init__(self, tareas, produccionDiaraDeseada, produccionDiaraActual):
        ...
        Ejemplo:\n
            ...
            BalnceoLinea = BalanceoLienaProgramacionLineal(tareas, produccionDiariaEsperada, tiempoFuncionamientoDiario)
...
class SecuenciacionReglaCDS():
    def __init__(self, tareas):
        ...
        Ejemplo:\n
            ...
            print(self.diccioanrio_tareas)\n
            print(self.combinaciones)\n
            print(self.secuencias_posibles)\n
            print(self.secuencias)\n
            print(self.tiempos_procesos_secuencias)\n
        '''
        self.tareas_base = tareas
        self.tareas = tareas
...
class ReglasSecuenciacion():
    ...
    def ReglasSecuenciacion(self):
        ...
        self.diccionario_reglas_secuanciacion['tiempo procesamiento mas corto'] = self.TiempoProcesamientoCorto()
        self.diccionario_reglas_secuanciacion['tiempo procesamiento mas largo'] = self.TiempoProcesamientoLargo()
        self.diccionario_reglas_secuanciacion['tiempo finalizacion mas temprano'] = self.TiempoFinalizacionTemprano()
        self.diccionario_reglas_secuanciacion['tiempo finalizacion mas tardio'] = self.TiempoFinalizacionTardio()
        self.diccionario_reglas_secuanciacion['relacion tiempo procesamiento con entrega mas corto'] = self.RelacionProcesameintoEntregaCorto()
